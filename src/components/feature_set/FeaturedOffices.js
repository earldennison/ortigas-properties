...
const SingleOfficeItem = (props) => {
  const { link } = props;
  return (
    <div className='featcomm-col col-md-4 wow'>
...
const FeaturedOffices = () => {
  return (
    <section className='featcomm-wrap'>
      <div className='textwidget'>
        <div className='featcomm-container container'>
          <TitleLine first='Featured' second='Offices' />
          <div className='featcomm-row row'>
            <SingleOfficeItem link='/properties/estancia-offices'>
              Estancia Offices
            </SingleOfficeItem>
            <SingleOfficeItem link='/properties/glaston-tower'>
              Glaston Tower
            </SingleOfficeItem>
            <SingleOfficeItem link='/properties/ibp-tower'>
              {' '}
              IBP Tower
            </SingleOfficeItem>
          </div>
