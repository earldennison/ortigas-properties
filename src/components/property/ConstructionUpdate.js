...
<div className="construction_update">
	...
	<div className="row year">
	  	<div className="col-sm-4 ground">
	  		<div className={`construction_stages ${update_status===1?"construction_update-active":""}`}>
	  		  <img  src="https://assets.ortigas.com.ph/data/images/ground.png"/>
	  		 <p></p>
	  		 <label>Ground Breaking</label>
	  		</div>
	  	</div>
	  	<div className="col-sm-4 presell">
	  		<div className={`construction_stages ${update_status===2?"construction_update-active":""}`}  >
	  		  <center>
            <img className="" src="https://assets.ortigas.com.ph/data/images/presell.png"/></center>
	  		<center><p></p></center>
	  		<center><label>Preselling</label></center>
	  		</div>
	  	</div>
	  	<div className="col-sm-4 turnover">
	  		<div className= {`construction_stages ${update_status===3?"construction_update-active":""}`}>
	  		<img className="" src="https://assets.ortigas.com.ph/data/images/turnover.png"/>
	  		<p></p>
	...
	<div className="button_progress hide"><a href="#">VIEW PROGRESS</a></div>
