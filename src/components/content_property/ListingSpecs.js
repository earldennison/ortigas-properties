      ...
      <div className='ip-ld-specs-content'>
        <div className='ip-ld-specs'>
          ...
          <div className='ip-ld-specs-inner'>
            <div className='ip-ld-price'>Project Specifications</div>
            ...
            <div className='ip-ld-specs-info'>
              <span className='ip-ld-specs-border top'>
                <img
                  src='https://www.carswellandassociates.com/wp-content/themes/carswellandassociates.com/images/listing-details/specs-border.png'
                  alt='border'
